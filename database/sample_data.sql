...
-- CLIENTES
-- ============================================================
INSERT INTO clients (client_type, institution_name, doctor_name, specialty, phone, email, city, country, relationship_level, client_status, activity_status, sales_representative, last_contact_date, next_followup_date, notes)
VALUES
('Doctor', NULL, 'Dr. Ricardo Mendoza', 'Oncología', '+507-6234-5678', 'rmendoza@medpan.com', 'Ciudad de Panamá', 'Panamá', 'Alto', 'Cerrado', 'Activo', 'Ana Castillo', '2026-03-01', '2026-03-15', 'Cliente clave. Prescriptor de alto volumen en oncología.'),
('Hospital', 'Hospital Nacional', 'Dr. Luis Herrera', 'General', '+507-6301-1234', 'lherrera@hosnac.gob.pa', 'Ciudad de Panamá', 'Panamá', 'Alto', 'Negociación', 'Activo', 'Carlos Vega', '2026-02-28', '2026-03-10', 'Contrato anual en revisión. Volumen alto.'),
('Clínica', 'Clínica Santa Fe', 'Dra. María Torres', 'Cardiología', '+507-6445-7890', 'mtorres@clinicasf.com', 'David', 'Panamá', 'Medio', 'Propuesta', 'Activo', 'Ana Castillo', '2026-02-20', '2026-03-05', 'Interesados en línea cardiológica completa.'),
('Doctor', NULL, 'Dr. Fernando Ríos', 'Endocrinología', '+507-6512-3456', 'frios@gmail.com', 'Chitré', 'Panamá', 'Bajo', 'Contactado', 'Activo', 'Miguel López', '2026-02-15', '2026-03-01', 'Primer contacto. Potencial de crecimiento medio.'),
('Farmacia', 'Farmacia Central', NULL, 'General', '+507-6100-0001', 'info@farmaciacentral.pa', 'Colón', 'Panamá', 'Medio', 'Cerrado', 'Activo', 'Carlos Vega', '2026-03-05', '2026-03-20', 'Pedidos recurrentes mensuales.'),
('Hospital', 'Hospital Chiriquí', 'Dr. Pedro Sánchez', 'General', '+507-6788-9012', 'psanchez@hospchiriqui.com', 'David', 'Panamá', 'Alto', 'Cerrado', 'Activo', 'Miguel López', '2026-03-10', '2026-04-01', 'Contrato vigente. Compras regulares.'),
('Doctor', NULL, 'Dra. Carmen Delgado', 'Dermatología', '+507-6333-4455', 'cdelgado@dermacare.com', 'Ciudad de Panamá', 'Panamá', 'Medio', 'Propuesta', 'Activo', 'Ana Castillo', '2026-02-25', '2026-03-12', 'Evaluando productos dermatológicos.'),
('Clínica', 'Centro Médico Paitilla', NULL, 'Multi-especialidad', '+507-6200-0000', 'compras@cmpaitilla.com', 'Ciudad de Panamá', 'Panamá', 'Alto', 'Negociación', 'Activo', 'Carlos Vega', '2026-03-08', '2026-03-18', 'Gran volumen potencial. Múltiples departamentos.'),
('Doctor', NULL, 'Dr. Jorge Salas', 'Neurología', '+507-6900-1122', 'jsalas@neurocare.pa', 'Ciudad de Panamá', 'Panamá', 'Bajo', 'Potencial', 'Activo', 'Miguel López', '2026-01-20', '2026-03-20', 'Lead reciente. Necesita seguimiento.'),
('Hospital', 'Hospital Santo Tomás', 'Dra. Elena Vargas', 'General', '+507-6700-3344', 'evargas@hstomas.gob.pa', 'Ciudad de Panamá', 'Panamá', 'Alto', 'Cerrado', 'Activo', 'Ana Castillo', '2026-03-12', '2026-04-01', 'Hospital público de alto volumen.'),
('Doctor', NULL, 'Dr. Alberto Pineda', 'Oncología', '+507-6555-6677', 'apineda@oncomed.pa', 'Santiago', 'Panamá', 'Medio', 'Contactado', 'Inactivo', '2026-01-15', NULL, NULL, 'Sin respuesta desde enero. Evaluar re-contacto.'),
('Clínica', 'Clínica Boyd', NULL, 'General', '+507-6400-8899', 'admin@clinicaboyd.com', 'Ciudad de Panamá', 'Panamá', 'Bajo', 'Potencial', 'Perdido', NULL, 'Precio', 'Carlos Vega', '2025-12-01', NULL, 'Perdido por precio. Competidor ofreció 15% menos.');
