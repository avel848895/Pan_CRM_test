...
const CRM_DATA = {
    ...
    // ========================================
    clients: [
        { client_id: 1, client_type: 'Doctor', institution_name: null, doctor_name: 'Dr. Ricardo Mendoza', specialty: 'Oncología', phone: '+507-6234-5678', email: 'rmendoza@medpan.com', city: 'Ciudad de Panamá', country: 'Panamá', relationship_level: 'Alto', client_status: 'Cerrado', activity_status: 'Activo', inactive_date: null, lost_reason: null, sales_representative: 'Ana Castillo', last_contact_date: '2026-03-01', next_followup_date: '2026-03-15', notes: 'Cliente clave. Prescriptor de alto volumen en oncología.' },
        { client_id: 2, client_type: 'Hospital', institution_name: 'Hospital Nacional', doctor_name: 'Dr. Luis Herrera', specialty: 'General', phone: '+507-6301-1234', email: 'lherrera@hosnac.gob.pa', city: 'Ciudad de Panamá', country: 'Panamá', relationship_level: 'Alto', client_status: 'Negociación', activity_status: 'Activo', inactive_date: null, lost_reason: null, sales_representative: 'Carlos Vega', last_contact_date: '2026-02-28', next_followup_date: '2026-03-10', notes: 'Contrato anual en revisión. Volumen alto.' },
        { client_id: 3, client_type: 'Clínica', institution_name: 'Clínica Santa Fe', doctor_name: 'Dra. María Torres', specialty: 'Cardiología', phone: '+507-6445-7890', email: 'mtorres@clinicasf.com', city: 'David', country: 'Panamá', relationship_level: 'Medio', client_status: 'Propuesta', activity_status: 'Activo', inactive_date: null, lost_reason: null, sales_representative: 'Ana Castillo', last_contact_date: '2026-02-20', next_followup_date: '2026-03-05', notes: 'Interesados en línea cardiológica completa.' },
        { client_id: 4, client_type: 'Doctor', institution_name: null, doctor_name: 'Dr. Fernando Ríos', specialty: 'Endocrinología', phone: '+507-6512-3456', email: 'frios@gmail.com', city: 'Chitré', country: 'Panamá', relationship_level: 'Bajo', client_status: 'Contactado', activity_status: 'Activo', inactive_date: null, lost_reason: null, sales_representative: 'Miguel López', last_contact_date: '2026-02-15', next_followup_date: '2026-03-01', notes: 'Primer contacto. Potencial de crecimiento medio.' },
        { client_id: 5, client_type: 'Farmacia', institution_name: 'Farmacia Central', doctor_name: null, specialty: 'General', phone: '+507-6100-0001', email: 'info@farmaciacentral.pa', city: 'Colón', country: 'Panamá', relationship_level: 'Medio', client_status: 'Cerrado', activity_status: 'Activo', inactive_date: null, lost_reason: null, sales_representative: 'Carlos Vega', last_contact_date: '2026-03-05', next_followup_date: '2026-03-20', notes: 'Pedidos recurrentes mensuales.' },
        { client_id: 6, client_type: 'Hospital', institution_name: 'Hospital Chiriquí', doctor_name: 'Dr. Pedro Sánchez', specialty: 'General', phone: '+507-6788-9012', email: 'psanchez@hospchiriqui.com', city: 'David', country: 'Panamá', relationship_level: 'Alto', client_status: 'Cerrado', activity_status: 'Activo', inactive_date: null, lost_reason: null, sales_representative: 'Miguel López', last_contact_date: '2026-03-10', next_followup_date: '2026-04-01', notes: 'Contrato vigente. Compras regulares.' },
        { client_id: 7, client_type: 'Doctor', institution_name: null, doctor_name: 'Dra. Carmen Delgado', specialty: 'Dermatología', phone: '+507-6333-4455', email: 'cdelgado@dermacare.com', city: 'Ciudad de Panamá', country: 'Panamá', relationship_level: 'Medio', client_status: 'Propuesta', activity_status: 'Activo', inactive_date: null, lost_reason: null, sales_representative: 'Ana Castillo', last_contact_date: '2026-02-25', next_followup_date: '2026-03-12', notes: 'Evaluando productos dermatológicos.' },
        { client_id: 8, client_type: 'Clínica', institution_name: 'Centro Médico Paitilla', doctor_name: null, specialty: 'Multi-especialidad', phone: '+507-6200-0000', email: 'compras@cmpaitilla.com', city: 'Ciudad de Panamá', country: 'Panamá', relationship_level: 'Alto', client_status: 'Negociación', activity_status: 'Activo', inactive_date: null, lost_reason: null, sales_representative: 'Carlos Vega', last_contact_date: '2026-03-08', next_followup_date: '2026-03-18', notes: 'Gran volumen potencial. Múltiples departamentos.' },
        { client_id: 9, client_type: 'Doctor', institution_name: null, doctor_name: 'Dr. Jorge Salas', specialty: 'Neurología', phone: '+507-6900-1122', email: 'jsalas@neurocare.pa', city: 'Ciudad de Panamá', country: 'Panamá', relationship_level: 'Bajo', client_status: 'Potencial', activity_status: 'Activo', inactive_date: null, lost_reason: null, sales_representative: 'Miguel López', last_contact_date: '2026-01-20', next_followup_date: '2026-03-20', notes: 'Lead reciente. Necesita seguimiento.' },
        { client_id: 10, client_type: 'Hospital', institution_name: 'Hospital Santo Tomás', doctor_name: 'Dra. Elena Vargas', specialty: 'General', phone: '+507-6700-3344', email: 'evargas@hstomas.gob.pa', city: 'Ciudad de Panamá', country: 'Panamá', relationship_level: 'Alto', client_status: 'Cerrado', activity_status: 'Activo', inactive_date: null, lost_reason: null, sales_representative: 'Ana Castillo', last_contact_date: '2026-03-12', next_followup_date: '2026-04-01', notes: 'Hospital público de alto volumen.' },
        { client_id: 11, client_type: 'Doctor', institution_name: null, doctor_name: 'Dr. Alberto Pineda', specialty: 'Oncología', phone: '+507-6555-6677', email: 'apineda@oncomed.pa', city: 'Santiago', country: 'Panamá', relationship_level: 'Medio', client_status: 'Contactado', activity_status: 'Inactivo', inactive_date: '2026-01-15', lost_reason: null, sales_representative: null, last_contact_date: null, next_followup_date: null, notes: 'Sin respuesta desde enero. Evaluar re-contacto.' },
        { client_id: 12, client_type: 'Clínica', institution_name: 'Clínica Boyd', doctor_name: null, specialty: 'General', phone: '+507-6400-8899', email: 'admin@clinicaboyd.com', city: 'Ciudad de Panamá', country: 'Panamá', relationship_level: 'Bajo', client_status: 'Potencial', activity_status: 'Perdido', inactive_date: null, lost_reason: 'Precio', sales_representative: 'Carlos Vega', last_contact_date: '2025-12-01', next_followup_date: null, notes: 'Perdido por precio. Competidor ofreció 15% menos.' }
    ],
...
// ========================================
const TABLE_FIELDS = {
    clients: ['client_id', 'client_type', 'institution_name', 'doctor_name', 'specialty', 'phone', 'email', 'city', 'country', 'relationship_level', 'client_status', 'activity_status', 'inactive_date', 'lost_reason', 'sales_representative', 'last_contact_date', 'next_followup_date', 'notes'],
